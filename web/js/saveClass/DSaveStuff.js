$('#dispatcher_change_stuff_button').live('click', function(event, ui){
    var target = $('#result');
...
$('#dispatcher_form_stuff_ajax').live('submit', function(event, ui){
    $(this).ajaxSubmit({
       success: saveStuff, 
...
function saveStuff()
{
  var target = $('#dispatcher_change_stuff_value');
  var loading_img = $('#loading_stuff');
  var claim_id = $('.claim_id').attr('id');
  edit_link = '/dispatcher.php/claimopened/getstuffajax/id/'+claim_id;
