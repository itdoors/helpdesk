...
$summ_columns = isset($summ_columns) ? $summ_columns : null;
?>
<script>
(function($) {
/*
...
$(document).ready(function(){
   <?php (file_exists($full_path.'_datatables_before'.$prefix.'.php')) ? include_partial('common/datatables_before'.$prefix) : null?>
    var oTable = $('#example').dataTable({
            ...
            <?php (file_exists($full_path.'_datatables_settings'.$prefix.'.php')) ? include_partial('common/datatables_settings'.$prefix, array('date_sorting' => $date_sorting, 'summ_columns' => $summ_columns)): null?>
    });
