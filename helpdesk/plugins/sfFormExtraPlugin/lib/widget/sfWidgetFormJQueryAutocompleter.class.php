...
class sfWidgetFormJQueryAutocompleter extends sfWidgetFormInput
{
  ...
  public function render($name, $value = null, $attributes = array(), $errors = array())
  {
    ...
    $callback = $this->getOption('js_callback') ? $this->getOption('js_callback').'.apply(this);' : '';
    
    if ($this->getOption('js_onSuccess'))
    {
      $attributes['data-onSuccess'] = $this->getOption('js_onSuccess');
    }
