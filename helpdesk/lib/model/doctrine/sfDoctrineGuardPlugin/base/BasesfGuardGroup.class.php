 ...
 * @method sfGuardGroup        setDocGroups()                Sets the current record's "DocGroups" collection
 ...
 * @method sfGuardGroup        setDocDocumentGroupSfGroups() Sets the current record's "DocDocumentGroupSfGroups" collection
 * 
 * @package    helpdesk
 * @subpackage model
