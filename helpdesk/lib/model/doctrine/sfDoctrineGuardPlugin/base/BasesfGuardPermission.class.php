 ...
 * @property Doctrine_Collection $WidgetList
 ...
 * @method Doctrine_Collection getWidgetList()             Returns the current record's "WidgetList" collection
 ...
 * @method sfGuardPermission   setWidgetList()             Sets the current record's "WidgetList" collection
 * @method sfGuardPermission   setWidgetListPermission()   Sets the current record's "WidgetListPermission" collection
 * 
 * @package    helpdesk
 * @subpackage model
