...
/**
 * DogovorDepartment form base class.
 *
 * @method DogovorDepartment getObject() Returns the current form's model object
 *
 * @package    helpdesk
 * @subpackage form
 ...
 */
abstract class BaseDogovorDepartmentForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'dop_dogovor_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('DopDogovor'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('dogovor_department[%s]');
