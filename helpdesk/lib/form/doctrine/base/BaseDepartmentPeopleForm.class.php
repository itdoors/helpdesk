...
abstract class BaseDepartmentPeopleForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'admission_date_not_officially' => new sfWidgetFormDate(),
      'dismissal_date_not_officially' => new sfWidgetFormDate(),
      'individual_id'                 => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Individual'), 'add_empty' => true)),
      'guid_department_people'        => new sfWidgetFormInputText(),
      'guid_individual'               => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'admission_date_not_officially' => new sfValidatorDate(array('required' => false)),
      'dismissal_date_not_officially' => new sfValidatorDate(array('required' => false)),
      'individual_id'                 => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Individual'), 'required' => false)),
      'guid_department_people'        => new sfValidatorString(array('max_length' => 32, 'required' => false)),
      'guid_individual'               => new sfValidatorString(array('max_length' => 32, 'required' => false)),
