...
abstract class BaseDepartmentPeopleFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'admission_date_not_officially' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'dismissal_date_not_officially' => new sfWidgetFormFilterDate(array('from_date' => new sfWidgetFormDate(), 'to_date' => new sfWidgetFormDate())),
      'individual_id'                 => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Individual'), 'add_empty' => true)),
      'guid_department_people'        => new sfWidgetFormFilterInput(),
      'guid_individual'               => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'admission_date_not_officially' => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      'dismissal_date_not_officially' => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDate(array('required' => false)), 'to_date' => new sfValidatorDateTime(array('required' => false)))),
      'individual_id'                 => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Individual'), 'column' => 'id')),
      'guid_department_people'        => new sfValidatorPass(array('required' => false)),
      'guid_individual'               => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'admission_date'                => 'Date',
      'dismissal_date'                => 'Date',
      'admission_date_not_officially' => 'Date',
      'dismissal_date_not_officially' => 'Date',
      'individual_id'                 => 'ForeignKey',
      'guid_department_people'        => 'Text',
      'guid_individual'               => 'Text',
      'passport'                      => 'Text',
      'mpk_id'                        => 'ForeignKey',
    );
  }
