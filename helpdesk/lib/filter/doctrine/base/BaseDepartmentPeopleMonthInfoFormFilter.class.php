...
abstract class BaseDepartmentPeopleMonthInfoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'surcharge_type_key'               => new sfWidgetFormFilterInput(),
      'bonus_type_key'                   => new sfWidgetFormFilterInput(),
      'fine_type_key'                    => new sfWidgetFormFilterInput(),
      'surcharge_description'            => new sfWidgetFormFilterInput(),
      'bonus_description'                => new sfWidgetFormFilterInput(),
      'fine_description'                 => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'surcharge_type_key'               => new sfValidatorPass(array('required' => false)),
      'bonus_type_key'                   => new sfValidatorPass(array('required' => false)),
      'fine_type_key'                    => new sfValidatorPass(array('required' => false)),
      'surcharge_description'            => new sfValidatorPass(array('required' => false)),
      'bonus_description'                => new sfValidatorPass(array('required' => false)),
      'fine_description'                 => new sfValidatorPass(array('required' => false)),
