...
abstract class BasesfGuardPermissionFormFilter extends BaseFormFilterDoctrine
{
  ...
  public function addWidgetListListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    if (!is_array($values))
    {
      $values = array($values);
    ...
    $query
      ...
      ->andWhereIn('WidgetListPermission.widget_id', $values)
    ;
  }
