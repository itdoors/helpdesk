...
<table cellspacing="0" width="100%" class="gray" id="example">  
  ...
  <tbody>
    ...
    <tr>
      <td><?php echo __('Work list')?>: <?php echo htmlspecialchars_decode(str_replace(' &lt;br /&gt;',' ', $claim->getWorkList()))?><span style="color:#F3F5F7; text-indent: -9999px;"><?php echo $claim->getId()?></span></td> 
